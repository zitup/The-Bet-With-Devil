...
import {IUniswapV3Pool} from "../interfaces/external/UniswapV3/IUniswapV3Pool.sol";
...
library OracleLibrary {
    ...
    function getPrice(int24 tick) public pure returns (uint256) {
        uint160 sqrtPriceX96 = TickMath.getSqrtRatioAtTick(tick);
        uint256 ratioX192 = uint256(sqrtPriceX96) * uint256(sqrtPriceX96);
        uint256 price = ratioX192 >> 96;
        return price;
    }
